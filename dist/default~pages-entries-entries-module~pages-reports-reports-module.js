...
/***/ "./src/app/pages/entries/shared/model/entry.model.ts":
/*!***********************************************************!*\
  !*** ./src/app/pages/entries/shared/model/entry.model.ts ***!
  \***********************************************************/
...
var Entry = /** @class */ (function () {
    function Entry(id, name, description, type, amount, date, paid, categoriaId, categoria) {
        this.id = id;
        this.name = name;
    ...
    Entry.fromJson = function (jsonData) {
...
/***/ "./src/app/pages/entries/shared/service/entry.service.ts":
/*!***************************************************************!*\
  !*** ./src/app/pages/entries/shared/service/entry.service.ts ***!
  \***************************************************************/
...
/* harmony import */ var _model_entry_model__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../model/entry.model */ "./src/app/pages/entries/shared/model/entry.model.ts");
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! moment */ "./node_modules/moment/moment.js");
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(moment__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var src_app_pages_categorias_shared_service_categoria_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/pages/categorias/shared/service/categoria.service */ "./src/app/pages/categorias/shared/service/categoria.service.ts");
...
var EntryService = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(EntryService, _super);
    function EntryService(injector, categoriaService) {
        var _this = _super.call(this, 'api/entries', injector, _model_entry_model__WEBPACK_IMPORTED_MODULE_4__["Entry"].fromJson) || this;
        _this.injector = injector;
        _this.categoriaService = categoriaService;
        return _this;
    }
    EntryService.prototype.create = function (entry) {
        return this.setCategoryAndSendToServer(entry, _super.prototype.create.bind(this));
    };
    EntryService.prototype.update = function (entry) {
        return this.setCategoryAndSendToServer(entry, _super.prototype.update.bind(this));
    };
    EntryService.prototype.getByMonthAndYear = function (month, year) {
        var _this = this;
        return this.getAll().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (entries) { return _this.filterByMonthAndYear(entries, month, year); }));
    };
    EntryService.prototype.filterByMonthAndYear = function (entries, month, year) {
        return entries.filter(function (entry) {
            var entryDate = moment__WEBPACK_IMPORTED_MODULE_5__(entry.date, 'DD/MM/YYYY');
            var monthMatches = entryDate.month() + 1 === +month;
            var yearMatches = entryDate.year() === +year;
            if (monthMatches && yearMatches) {
                return entry;
            }
        });
    };
    EntryService.prototype.setCategoryAndSendToServer = function (entry, sendFn) {
        return this.categoriaService.getById(entry.categoriaId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["flatMap"])(function (categoria) {
    ...
    EntryService.ctorParameters = function () { return [
        { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Injector"] },
        { type: src_app_pages_categorias_shared_service_categoria_service__WEBPACK_IMPORTED_MODULE_6__["CategoriaService"] }
    ]; };
    EntryService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: 'root'
        }),
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injector"],
            src_app_pages_categorias_shared_service_categoria_service__WEBPACK_IMPORTED_MODULE_6__["CategoriaService"]])
    ], EntryService);
    return EntryService;
